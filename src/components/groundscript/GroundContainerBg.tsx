...
const images = ["/assets/Arcos-gold.svg"];
...
const scales = [ 0.9, 0.35];
const rotations = [ "left", "right"];

export function GroundContainerBg() {
  ...
  return (
    <div className="groundmask-gold absolute inset-0 flex items-center justify-center overflow-hidden">
      <AnimatePresence>
        {scales.map((scale, i) => {
