...
import { GroundTrioBg } from "@/components/groundscript/GroundTrioBg";
    ...
    <section className="hero-minimal">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "linear-gradient(135deg, #f8fafc 0%, #f1f5f9 100%) ,url(/images/panama-skyline.jpg)",
          }}
        />
      ...
      {/* Enhanced Content */}
      <div className="hero-content-minimal text-left ground-hero-master ">
        ...
        <div className="ground-along ground-magicard ">
          ...
          <p
            className="text-xl md:text-2xl text-gray-100 mb-7 max-w-3xl leading-relaxed animate-slide-up"
        ...
        <div className="ground-along ground-pad-hero-fix">
          {/* Enhanced Key Benefits */}
          <div
            className="flex flex-wrap gap-4 mb-7 animate-slide-up"
          ...
          <div
            className="flex flex-col sm:flex-row gap-6 mb-20 animate-slide-up"
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 z-20">
        <div className="flex flex-col items-center text-gray-100 animate-float">
